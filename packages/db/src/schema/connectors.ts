 ...
 * semantics). Recomputed from base rows inside the sync write transaction
 * (see DailyBalanceService). Historical net-worth snapshotting may later
 * replace this as the series source.
 */
